...
ActiveRecord::Schema.define(version: 20141201080310) do

  create_table "alipay_feedbacks", force: true do |t|
    ...
    t.decimal  "total_fee",      precision: 20, scale: 2, default: 0.0
    t.integer  "quantity"
    t.datetime "paid_at"
  ...
  create_table "alipay_payments", force: true do |t|
